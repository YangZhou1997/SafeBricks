...
pub struct NetBricksContext {
    pub ports: HashMap<String, Arc<SimulatePort>>,
    pub rx_queues: HashMap<i32, Vec<CacheAligned<SimulateQueue>>>,
    ...
    fn start_scheduler(&mut self, core: i32) {
        ...
        let join_handle = builder
            ...
            .spawn(move || {
                ...
                // the NF code has been pinned on one core; we do not need to pin it again.
